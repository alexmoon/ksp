...
(function() {
  ...
  this.lambert = function(mu, pos1, pos2, dt, maxRevs, prograde) {
    var N, angleParameter, c, deltaPos, ftau, fy, invSqrtM, invSqrtN, m, minimumEnergyNormalizedTime, minimumNormalizedTime, n, normalizedTime, parabolicNormalizedTime, phix, phiy, pushSolution, r1, r2, solutions, sqrtMu, transferAngle, x, x1, x2, y, _i;
      ...
      for (N = _i = 0; 0 <= maxRevs ? _i <= maxRevs : _i >= maxRevs; N = 0 <= maxRevs ? ++_i : --_i) {
        if (N > 0 && N === maxRevs) {
          ...
          if (angleParameter === 1) {
            ...
            x = findRoot(0, 1, 1e-6, function(x) {
        ...
        } else if (N > 0 || normalizedTime > minimumEnergyNormalizedTime) {
