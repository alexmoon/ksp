...
(function() {
  var HALF_PI, Orbit, TWO_PI, acosh, angleInPlane, brentsMethod, circularToEscapeDeltaV, cosh, crossProduct, ejectionAngleFromPeriapsis, ejectionAngleToPrograde, ejectionPeriapsisDirection, goldenSectionSearch, insertionToCircularDeltaV, newtonsMethod, normalize, projectToPlane, sign, sinh;
  ...
  Orbit.transfer = function(transferType, originBody, destinationBody, t0, dt, initialOrbitalVelocity, finalOrbitalVelocity, p0, v0, n0, p1, v1, planeChangeAngleToIntercept) {
    var ballisticTransfer, dv, ejectionAngle, ejectionDeltaV, ejectionDeltaVector, ejectionDirection, ejectionInclination, ejectionVelocity, insertionDeltaV, insertionDeltaVector, insertionInclination, insertionVelocity, j, len, minDeltaV, nu0, nu1, orbit, p1InOriginPlane, periapsisDirection, planeChangeAngle, planeChangeAxis, planeChangeDeltaV, planeChangeRotation, planeChangeTime, planeChangeTransfer, planeChangeTrueAnomaly, ref, referenceBody, relativeInclination, s, solutions, t1, theta, transferAngle, trueAnomalyAtIntercept, v1InOriginPlane, x, x1, x2;
