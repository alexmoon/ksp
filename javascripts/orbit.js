...
(function() {
  var Orbit, acosh, circularToHyperbolicDeltaV, cosh, crossProduct, gaussTimeOfFlight, halfPi, sinh, transferVelocities, twoPi;
  ...
  Orbit.ballisticTransfer = function(referenceBody, t0, p0, v0, n0, t1, p1, v1, n1, initialOrbitalVelocity, finalOrbitalVelocity, detailed) {
    var dt, ejectionDeltaV, ejectionDeltaVector, ejectionInclination, ejectionVelocity, insertionDeltaV, insertionDeltaVector, insertionInclination, insertionVelocity, longTransfer, shortTransfer, transfer, transferAngle, _i, _len, _ref, _ref1;
    dt = t1 - t0;
    shortTransfer = {};
    longTransfer = {};
