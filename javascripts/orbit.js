...
(function() {
  var GOLDEN_RATIO, HALF_PI, Orbit, TWO_PI, acosh, angleInPlane, circularToHyperbolicDeltaV, cosh, crossProduct, ejectionAngle, goldenSectionSearch, newtonsMethod, normalize, projectToPlane, sinh;
  ...
  Orbit.transfer = function(transferType, referenceBody, t0, p0, v0, n0, t1, p1, v1, initialOrbitalVelocity, finalOrbitalVelocity, originBody, planeChangeAngleToIntercept) {
    var ballisticTransfer, burnDirection, dt, e, ejectionDeltaV, ejectionDeltaVector, ejectionInclination, ejectionVelocity, insertionDeltaV, insertionDeltaVector, insertionInclination, insertionVelocity, mu, normalDeltaV, orbit, p1InOriginPlane, planeChangeAngle, planeChangeAxis, planeChangeDeltaV, planeChangeRotation, planeChangeTime, planeChangeTransfer, planeChangeTrueAnomaly, positionDirection, progradeDeltaV, progradeDirection, r, radialDeltaV, relativeInclination, transfer, transferAngle, trueAnomalyAtIntercept, v1InOriginPlane, vinf, x, x1, x2, _ref, _ref1, _ref2;
