...
(function() {
  var PLOT_HEIGHT, PLOT_WIDTH, PLOT_X_OFFSET, TIC_LENGTH, angleString, canvasContext, clamp, deltaVs, destinationOrbit, distanceString, durationString, earliestArrival, earliestDeparture, finalOrbitalVelocity, hourMinSec, i, initialOrbitalVelocity, kerbalDateString, numberWithCommas, originBody, originOrbit, palette, plotImageData, prepareCanvas, worker, xScale, yScale, _i, _j, _k, _l, _m;
