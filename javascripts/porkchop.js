...
(function() {
  var angleString, deltaVAbbr, distanceString, numberWithCommas, porkchopPlot, selectedTransfer, showTransferDetails, showTransferDetailsForPoint, sign;
  ...
  $(document).ready(function() {
    var celestialBodyForm, ejectionDeltaVInfoContent, missionForm;
    ...
    return $(missionForm).on('submit', function(event) {
      var scrollTop;
