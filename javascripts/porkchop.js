...
(function() {
  var PLOT_HEIGHT, PLOT_WIDTH, PLOT_X_OFFSET, TIC_LENGTH, angleString, canvasContext, clamp, dateFromString, deltaVAbbr, deltaVs, destinationOrbit, distanceString, drawDeltaVScale, drawPlot, durationString, earliestDeparture, finalOrbitalVelocity, hourMinSec, i, initialOrbitalVelocity, isBlank, kerbalDateString, numberWithCommas, originBody, originOrbit, palette, plotImageData, prepareCanvas, prepareOrigins, selectedPoint, shortKerbalDateString, shortestTimeOfFlight, showTransferDetails, sign, transferType, updateAdvancedControls, worker, xScale, yScale, _i, _j, _k, _l, _m;
